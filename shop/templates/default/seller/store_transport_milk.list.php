...
<div class="tabmenu">
  ...
  <a class="ncsc-btn ncsc-btn-green" href="index.php?act=store_transport_milk&op=add&type=<?php echo $_GET['type'];?>"><?php echo $lang['transport_tpl_add'];?> </a> </div>
<!-----------------list begin------------------------>
...
$(function(){	
	$('a[class="J_Delete ncsc-btn-mini"]').click(function(){
		...
		get_confirm('<?php echo $lang['transport_del_confirm'];?>','<?php echo SHOP_SITE_URL;?>/index.php?act=store_transport_milk&op=delete&type=<?php echo $_GET['type'];?>&id='+id);
...
//		return true;
	...
	$('a[class="J_Modify ncsc-btn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
		$(this).attr('href','<?php echo SHOP_SITE_URL;?>/index.php?act=store_transport_milk&op=edit&type=<?php echo $_GET['type'];?>&id='+id);
		return true;
	});
	...
	$('a[class="J_Clone ncsc-btn-mini"]').click(function(){
		var id = $(this).attr('data-id');
		if(typeof(id) == 'undefined') return false;
		$(this).attr('href','<?php echo SHOP_SITE_URL;?>/index.php?act=store_transport_milk&op=clone&type=<?php echo $_GET['type'];?>&id='+id);
		return true;
	});
