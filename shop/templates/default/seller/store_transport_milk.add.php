...
<div class="ncsc-form-default">
  <form method="post" id="tpl_form" name="tpl_form" action="index.php?act=store_transport_milk&op=save">
  ...
  <div id="dialog_areas" class="dialog-areas" style="display:none">
    <div class="ks-contentbox">
      ...
      <form method="post">
        <div id="J_CityList" style=" height: 400px;overflow: auto;">
          <?php require(template('seller/store_transport_milk_area'));?>
        </div>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/js/transport_milk.js"></script>
<script>
$(function(){
