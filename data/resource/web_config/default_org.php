...
<div class="home-standard-layout-org wrapper style-<?php echo $output['style_name'];?>">
    ...
    <div class="middle-layout">
        <ul class="tabs-nav">
            <?php if (!empty($output['code_recommend_list_org']['code_info']) && is_array($output['code_recommend_list_org']['code_info'])) {
                $i = 0;
                ?>
