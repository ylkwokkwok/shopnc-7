...
define('MILK_RETURN_URL', $config['milk_return_url']);
define('MILK_RETURN_URL_P', $config['milk_return_url_p']);
define('MILK_RETURN_URL_Z', $config['milk_return_url_z']);

define('BASE_DATA_PATH',BASE_ROOT_PATH.'/data');
define('BASE_UPLOAD_PATH',BASE_DATA_PATH.'/upload');
define('BASE_RESOURCE_PATH',BASE_DATA_PATH.'/resource');

define('CHARSET',$config['db']["mobile"]['dbcharset']);
...
define('DBPRE',$config['db']["mobile"]['tablepre']);
define('DBNAME',$config['db']["mobile"]['dbname']);
