...
(35, 1, 'http://www.baidu.com/', 1, 1, '火爆销售中', '火爆销售中<br />', 1389864697),
...
INSERT INTO `#__seo` (`id`, `title`, `keywords`, `description`, `type`) VALUES (1, '{sitename} - 程序来源于多用户商城', '多用户商城,PHP商城系统,多用户商城商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', '多用户商城专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index'),
(2, '{sitename} - 团购', '多用户商城,{sitename}', '多用户商城专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group'),
(3, '{sitename} - {name}', '多用户商城,{name},{sitename}', '多用户商城,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', '多用户商城,{sitename}', '多用户商城,{sitename}', 'brand'),
(5, '{sitename} - {name}', '多用户商城,{sitename},{name}', '多用户商城,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', '多用户商城,{sitename},{name}', '多用户商城,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - 积分商城', '多用户商城,{sitename}', '多用户商城,{sitename}', 'point'),
(9, '{sitename} - {name}', '多用户商城,{sitename},{key}', '多用户商城,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', '多用户商城,{sitename}', '多用户商城,{sitename}', 'article'),
(11, '{sitename} - {name}', '多用户商城,{sitename},{key}', '多用户商城,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', '多用户商城,{sitename},{key}', '多用户商城,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', '多用户商城,{sitename},{key}', '多用户商城,{sitename},{description}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', '多用户商城,{sitename},{name}', '多用户商城,{sitename},{name}', 'sns');
